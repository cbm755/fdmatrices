function [Dxx,Dyy,Dxc,Dyc,Dxb,Dyb,Dxf,Dyf,Dxyc] = diff2d_matrices(x,y,use_ndgrid,BC)
%DIFF2D_MATRICES  Build discrete derivative matrices
%
%   Usage:
%   [Dxx,Dyy,Dxc,Dyc,Dxb,Dyb,Dxf,Dyf,Dxyc] = ...
%       diff2d_matrices(x,y,use_ndgrid,BC);
